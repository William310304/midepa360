...
export default function Index() {
  const datos: { id: string; nombre: string; path: Href }[] = [
    { id: "1", nombre: "Inmuebles", path: "/(drawer)/(tabs)/servicios/inmuebles"},
    { id: "2", nombre: "Visitas", path: "/(drawer)/(tabs)/servicios/visitas" },
    { id: "3", nombre: "Áreas Comunes", path: "/(drawer)/(tabs)/servicios/areas-comunes" },
    { id: "4", nombre: "Calendario", path: "/(drawer)/(tabs)/servicios/calendario" },
  ] as const;
